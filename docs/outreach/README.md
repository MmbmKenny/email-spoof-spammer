...
**Golden rules**
1. Every message is personalized with ONE real, observed fact.
2. Nothing is sent without your approval.
3. Three touches max (Day 1 / Day 3 / Day 7), then stop unless they engage.
4. Stop immediately if asked. Never message again after a "no" or "stop".
